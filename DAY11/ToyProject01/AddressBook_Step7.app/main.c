...
static int saveContacts(const char* fileName);
static int loadContacts(const char* fileName);
...
static int ab_init();			// 주소록 초기화
static void ab_free();			// 주소록 메모리 해제
